...
angular
  .module("App")
  .controller("playerDetailController", function(
    APIfactory,
    $scope,
    $state,
    $ionicModal,
    ...
    $scope.photoUrl =
      "https://cloudinary.com/console/media_library#/dialog/image/upload/perfil_li3dgc";
    var url = "";
    ...
    $scope.editar = function() {
      ...
      if ($scope.editing == true) $scope.botonEdit = "Cancel";
      else $scope.botonEdit = "Edit";
    ...
    //Modal Posiciones
    $ionicModal
      .fromTemplateUrl("positionModal.html", {
        scope: $scope,
    ...
    //Modal Dorsales
    $ionicModal
      .fromTemplateUrl("dorsalModal.html", {
        scope: $scope,
        animation: "slide-in-up"
      })
      .then(function(modal) {
